...
class HookEntry : IYukiHookXposedInit {
    ...
    private fun randomizeCoords(savedMultiplier: String, location: Location): Location {
    ...
    override fun onHook() = encase {
        loadApp {
            ...
            String::class.java.resolve().firstMethod {
                name = "contains"
            ...
            android.provider.Settings.Secure::class.java.resolve().firstMethod {
                name = "getInt"
            ...
            android.provider.Settings.Global::class.java.resolve().firstMethod {
                name = "getInt"
                parameters(android.content.ContentResolver::class.java, String::class.java)
            }.hook {
                before {
            ...
            java.io.FileInputStream::class.java.resolve().firstConstructor {
            ...
            android.location.Location::class.java.resolve().firstMethod {
                name = "getLatitude"
                emptyParameters()
            }.hook {
                before {
                    ...
                    val loc = if (lat.isNotBlank() && lng.isNotBlank()) {
